...
plt.ioff()
plt.savefig('cartpoleDQN_scores_10000_batch_128.png')
plt.show()

# torch.save(target_net.state_dict(), "target_net_weights_CART.pth")
# torch.save(policy_net.state_dict(), "policy_net_weights_CART.pth")
